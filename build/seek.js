        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const applicant of applicants.slice(0, this.LIMIT || applicants.length)) {
                    ...
                    // The description belongs to the vacancy this applicant was matched
                    // to (enumerated above), never to a separately title-keyed lookup.
                    applicant.vacancy_description = (_b = vacancy === null || vacancy === void 0 ? void 0 : vacancy.description) !== null && _b !== void 0 ? _b : undefined;
